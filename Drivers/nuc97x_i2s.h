 ...
 */
#ifndef DRIVER_NUC97X_I2S_H_
#define DRIVER_NUC97X_I2S_H_
...
/** @addtogroup NUC970_I2S_EXPORTED_CONSTANTS I2S Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC970_I2S_EXPORTED_CONSTANTS */

#define I2S_REF_CLOCK   12300000

typedef void (i2s_cbfunc_t)(uint32_t);


void I2S_Enable(void);
void I2S_Disable(void);
void I2S_SetMCLKFrequency(uint32_t u32SourceClockRate, uint32_t u32SampleRate);
void I2S_SetSampleRate(uint32_t u32SourceClockRate, uint32_t u32SampleRate, uint32_t u32DataBit, uint32_t u32Channel);
int32_t I2S_Control(uint32_t cmd, uint32_t arg0, uint32_t arg1);
